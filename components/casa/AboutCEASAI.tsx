        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">Thousands</div>
              <div className="text-sm text-gray-600">Analysts Trained Globally</div>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">3 Years</div>
              <div className="text-sm text-gray-600">Certification Validity</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                As the EU AI Act enforcement deadline for high-risk AI systems approaches (<strong>August 2, 2026</strong>), enterprises worldwide need certified AI Safety Analysts to ensure compliance, 
                transparency, and safety. CEASAI provides emerging open-source certification focused on safety and compliance, helping build a workforce of qualified professionals who understand the evolving landscape of AI governance and can help organizations navigate regulatory requirements responsibly.
              </p>
            </div>
          </div>
        </div>
