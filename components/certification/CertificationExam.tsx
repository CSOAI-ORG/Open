    ...
    <DashboardLayout>
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 flex overflow-hidden">
                  ...
                  >
                    <Card>
                      ...
                      <CardContent className="space-y-3">
                        {(currentQuestion.options as { id: string; text: string }[]).map((option: any) => {
          ...
          {/* Question navigator sidebar - Compact with progress */}
          <div className="w-64 border-l bg-muted/30 p-4 overflow-y-auto">
            ...
            {/* Compact Question Grid - Shows current section */}
              ...
              {questions.map((q: any, index: number) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "w-8 h-8 rounded text-xs font-medium relative transition-all",
                  ...
                  >
                    {index + 1}
                    {isFlagged && (
                      <Flag className="absolute -top-0.5 -right-0.5 h-2.5 w-2.5 text-amber-500 fill-amber-500" />
                    )}
                  </button>
                );
              })}
