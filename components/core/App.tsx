...
import MyCertificateGallery from "./pages/MyCertificateGallery";
...
import CronSetup from "./pages/admin/CronSetup";
...
import CharterDownload from "./pages/CharterDownload";
import HowItWorks from "./pages/HowItWorks";
import Licensing from "./pages/Licensing";
const ProsperityFund = () => <div className="min-h-screen bg-slate-900 text-white p-8"><h1 className="text-4xl font-bold">Prosperity Fund</h1><p className="mt-4">Coming Soon</p></div>;
...
import WatchdogHowItWorks from "./pages/WatchdogHowItWorks";
...
import CouncilSessionTranscripts from "./pages/CouncilSessionTranscripts";
import ThankYou from "./pages/ThankYou";

// Widget components - self-contained, no auth/backend required
        ...
        <TooltipProvider>
          <WidgetLayout>
            ...
            <Switch>
              ...
              <Route>{() => <Redirect to="/widget" />}</Route>
            </Switch>
          </WidgetLayout>
...
function App() {
  ...
  // Widget routes bypass the full app layout (no Header, Footer, Auth)
  ...
  return (
    <ErrorBoundary>
            ...
            <div className="flex flex-col min-h-screen">
              ...
              <main id="main-content" className="flex-1">
                <Switch>
                  ...
                  <Route path="/charter-download" component={CharterDownload} />
                  <Route path="/news" component={News} />
                  <Route path="/how-it-works" component={HowItWorks} />
                  <Route path="/licensing" component={Licensing} />
                  <Route path="/license" component={Licensing} />
                  <Route path="/regulatory" component={RegulatoryCompliance} />
                  ...
                  <Route path="/how-it-works/watchdog" component={WatchdogHowItWorks} />
                  ...
                  <Route path="/council-transcripts" component={CouncilSessionTranscripts} />
      ...
      <Route path="/watchdog/report" component={PublicWatchdogHub} />
                  ...
                  <Route path="/paid-courses"><Redirect to="/courses" /></Route>
                  ...
                  <Route path="/paid-courses-dashboard"><Redirect to="/courses" /></Route>
                  ...
                  <Route path="/badge/:certificateId" component={BadgePreview} />
                  <Route path="/badge" component={BadgePreview} />
                  <Route path="/admin/cron-setup" component={CronSetup} />
                  ...
                  <Route path="/certificates/gallery" component={MyCertificateGallery} />
                  <Route path="/gallery/:slug" component={CertificateGallery} />
