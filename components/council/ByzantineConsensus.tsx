...
import { CouncilDecisionHistory } from '@/components/CouncilDecisionHistory';
import { CouncilMemberShowcase } from '@/components/CouncilMemberShowcase';
import { CouncilWorkflowDiagram } from '@/components/CouncilWorkflowDiagram';
import { CouncilVotingAnalytics } from '@/components/CouncilVotingAnalytics';
import { CouncilLeaderboard } from '@/components/CouncilLeaderboard';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-white dark:bg-gray-950">
        <div className="container">
          ...
          <div className="space-y-12">
            {COUNCIL_CATEGORIES.map((category: any, catIndex: number) => (
              <motion.div
                key={category.title}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container">
          <h2 className="text-3xl font-bold mb-8 text-center">Meet the Council</h2>
          <CouncilMemberShowcase />
        </div>
      </section>
      ...
      <section className="py-16 bg-white dark:bg-gray-950">
        <div className="container">
          <h2 className="text-3xl font-bold mb-8 text-center">Decision History</h2>
          <CouncilDecisionHistory />
        </div>
      </section>

      {/* Council Voting Analytics */}
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container">
          <CouncilVotingAnalytics />
        </div>
      </section>
