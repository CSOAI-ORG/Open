      ...
      <section className="bg-gradient-to-r from-green-900 to-emerald-800 text-white py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-sm font-semibold text-emerald-300 mb-4 tracking-wide uppercase">Open Governance Methodology</p>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              SOAI-PDCA Framework
            </h1>
            <p className="text-xl text-green-100 mb-4">
              The open-source, publicly auditable methodology for continuous AI safety improvement.
              Adapted from the proven Deming cycle for AI governance.
            </p>
            <p className="text-lg text-emerald-300 mb-8">
              Used by enterprises, governments, and regulators worldwide. Free to implement. Transparent by design.
            </p>
