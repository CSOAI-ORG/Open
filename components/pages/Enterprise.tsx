          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-4">
                Leverage the open-source FAA for AI. Our Byzantine Council provides vendor-independent, 
                publicly auditable compliance assessments across all major frameworks.
              </p>
              <p className="text-lg text-emerald-300 mb-8">
                No vendor lock-in. No conflicts of interest. Just transparent, independent AI safety oversight.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {(['low', 'medium', 'high'] as const).map((level: any) => (
                      <label
                        key={level}
