      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            {settingsSections.map((section: any, idx: number) => {
          ...
          <div className="lg:col-span-2">
            ...
            >
                ...
                <Card className="bg-card border-border">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Your password is managed through your OAuth provider. To change your password, please visit your provider's settings.
                      </p>
                    </div>
              ...
              {activeSection !== "Profile" && activeSection !== "Payout Settings" && activeSection !== "Security" && activeSection !== "Notifications" && (
                <Card className="bg-card border-border">
                  <CardHeader>
