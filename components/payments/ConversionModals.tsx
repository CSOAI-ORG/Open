    ...
    switch (type) {
      case 'loi':
        return {
          ...
          description: 'Join 250,000 AI Safety Analysts. All training is now 100% FREE.',
          fields: ['name', 'email', 'phone'],
          buttonText: 'Start Free Training',
        };
      case 'course':
        return {
          title: 'Enroll in Free CEASAI Training',
          description: 'All courses are 100% FREE. Certification is 100% FREE. Zero barriers to entry.',
