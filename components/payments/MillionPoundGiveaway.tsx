  ...
  return (
    <div className="relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Select value={courseLevel} onValueChange={(v) => setCourseLevel(v as any)}>
                    ...
                    <SelectContent>
                      <SelectItem value="fundamentals">Fundamentals (FREE)</SelectItem>
                      <SelectItem value="advanced">Advanced (FREE)</SelectItem>
                      <SelectItem value="specialist">Specialist (FREE)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
        ...
        {/* Why Training is Free */}
        <div className="mt-16 text-center max-w-3xl mx-auto">
          <h3 className="text-2xl font-bold text-white mb-4">Why All Training is Now Free</h3>
          <p className="text-slate-400 leading-relaxed">
            Based on feedback from professionals worldwide, we're committed to making AI safety training accessible to everyone. 
            As the EU AI Act enforcement deadline approaches (August 2, 2026 for high-risk systems), demand is growing for qualified AI Safety Analysts in governance, risk assessment, and compliance roles. 
            The more professionals we train, the safer the future for all. 
            Training is <span className="text-white">100% free</span>.
            Certification is also <span className="text-white">100% free</span>. Zero payment barriers.
          </p>
        </div>
