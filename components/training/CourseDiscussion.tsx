...
export function CourseDiscussion({ courseId, lessonId }: CourseDiscussionProps) {
  ...
  const handleReply = (parentPostId?: number): void => {
  ...
  const handleMarkSolution = (postId: number): void => {
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted-foreground line-clamp-2">
                      <div dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(thread.content) }} />
                    </div>
        ...
        <>
          ...
          <div className="space-y-4">
            ...
            {threadDetails.posts && threadDetails.posts.length > 0 ? (
              threadDetails.posts.map((post: any) => (
