                ...
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 capitalize">
                    ...
                    {category !== 'necessary' && preferences && (
                      <Badge variant={(preferences as any)[category] ? "default" : "secondary"} className="ml-2">
                        {(preferences as any)[category] ? 'Enabled' : 'Disabled'}
                      </Badge>
                    )}
                  </CardTitle>
                ...
                <CardContent>
                  <div className="overflow-x-auto">
                    <Table>
                      ...
                      <TableBody>
                        {cookieData[category].map((cookie: any, index: number) => (
                          <TableRow key={index}>
