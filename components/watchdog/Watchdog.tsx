...
export default function Watchdog() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-6xl">
          <div className="text-center">
            ...
            <p className="text-2xl text-gray-300 leading-relaxed mb-4 max-w-4xl mx-auto">
              The world's first open, transparent AI incident database. Every report is public. 
              Every analysis is auditable. Every decision is accountable.
            </p>
            <p className="text-xl text-emerald-300 font-semibold mb-4">
              Become a certified AI Safety Analyst and join the global oversight network.
            </p>
            <p className="text-lg text-gray-400 mb-10">
              Earn $45-150/hour • Work remotely • Protect humanity • Build a future-proof career
            </p>
      ...
      {/* Join the Council Inline CTA */}
      <div className="container max-w-4xl py-8">
        <JoinCouncilCTA variant="inline" />
      </div>
