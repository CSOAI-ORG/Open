...
const conversionSteps: ConversionStep[] = [
  ...
  {
    step: 3,
    title: 'Get Free CEASA Certification',
    description: 'Get certified with legal rigor and industry recognition - completely free',
    icon: <Award className="w-8 h-8 text-purple-600" />,
    action: 'Free',
    cta: 'Get Certified',
    benefits: [
      'Free CEASA certificate',
  ...
  {
    step: 4,
    title: 'Advance to Professional Level',
    description: 'Become a certified AI safety analyst for enterprises - all free',
  ...
  },
  {
    ...
    description: 'Become a regulatory-level expert and policy influencer - all free',
    icon: <TrendingUp className="w-8 h-8 text-red-600" />,
    action: 'Free',
    cta: 'Become Expert',
    benefits: [
      'Free government agency access',
      'Policy influence',
      'Leadership roles',
    ],
  },
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="border-2 border-emerald-500">
            <CardHeader>
              <Badge className="w-fit mb-2 bg-emerald-500">100% FREE</Badge>
              <CardTitle className="text-lg">All Training Courses</CardTitle>
              <CardDescription>7 Regional Frameworks</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">$45-150/hr</p>
              </div>
              <div>
                <p className="text-sm text-gray-600 mb-1">Self-Paced Learning</p>
          ...
          <Card className="border-2 border-blue-600">
            <CardHeader>
              <Badge className="w-fit mb-2 bg-blue-500">100% FREE</Badge>
              <CardTitle className="text-lg">CEASAI Certification</CardTitle>
              <CardDescription>Official Certificate</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <p className="text-sm text-gray-600 mb-1">Certification Cost</p>
              ...
              <Button className="w-full bg-blue-600 hover:bg-blue-700">Get Certified</Button>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-green-600">
            <CardHeader>
              <Badge className="w-fit mb-2 bg-green-500">100% FREE</Badge>
              <CardTitle className="text-lg">Professional Network</CardTitle>
              <CardDescription>Lifetime Access</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <p className="text-sm text-gray-600 mb-1">Network Cost</p>
                <p className="text-2xl font-bold text-green-600">FREE</p>
              </div>
              <div>
                <p className="text-sm text-gray-600 mb-1">Includes</p>
                <p className="text-lg font-semibold text-green-600">Updates + Directory</p>
              </div>
              <div>
                <p className="text-sm text-gray-600 mb-1">Job Opportunities</p>
                <p className="text-lg font-semibold">Priority Access</p>
              </div>
