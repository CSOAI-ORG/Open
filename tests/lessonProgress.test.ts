...
describe('Lesson Progress Router', () => {
  ...
  beforeAll(async () => {
    ...
    testUserId = Number((userResult as any).insertId || 1);
    ...
    testCourseId = Number((courseResult as any).insertId || 1);
    ...
    testEnrollmentId = Number((enrollmentResult as any).insertId || 1);
    ...
    testLessonId = Number((lessonResult as any).insertId || 1);
  });
